...
#(3)              
# ##figure1:     model="DSLangmuir", param_guess= {'M1':100, 'K1':0.1,'M2':100,'K2':0.1})
#(3)                 
#    model="BET", param_guess= {'M':2.1, 'Ka':0.001180,'Kb':0.000024})
...
#              bulk =(1-a['%s_mole_fract' %gas2])/a['%s_mole_fract' %gas2]
        selectivity['P=%s' %total_pressure]=iast_component_loadings[1,:]/iast_component_loadings[0,:]/bulk
#################################################################################################
file_name1="data/data_binary_%s_%s_gas_%s_adsorption_%s_at_%s.dat" %(gas1,gas2,gas2,structure, temperature)
file_name2="data/data_binary_%s_%s_gas_%s_adsorption_%s_at_%s.dat" %(gas1,gas2,gas1,structure, temperature)
file_name3="data/data_binary_IAST_%s-%s_selectivity_%s_at_%s.dat" %(gas1,gas2,structure, temperature)
